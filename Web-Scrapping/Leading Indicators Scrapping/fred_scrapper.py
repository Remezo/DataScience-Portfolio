...
def pull_data(data):
	...
	for i, row in data.iterrows():
		...
		if (row.Source == "FRED"):
            ...
            API_KEY="FOO" #Please get your own key on the FRED WEBSITE

			file = requests.get("API_KEY".format(row.Data,"387a905393cc2ed7a711a24149359f52","json"))
...
def excel_to_sql(excel_file):
    ...
    AWS_KEY="foo" # you can get this key once you create an RDS DATABASE on AWS

	engine = create_engine(AWS_KEY, poolclass=NullPool)
